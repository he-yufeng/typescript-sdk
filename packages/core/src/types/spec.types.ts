 ...
 * Last updated from commit: 8e192a2277251483768fb254fee4fc3b8da3944f
 *
 ...
 * @category `tools/call`
 */
export interface CallToolRequestParams extends InputResponseRequestParams, TaskAugmentedRequestParams {
    /**
...
/** @internal */
export type ClientNotification = CancelledNotification | ProgressNotification | TaskStatusNotification;
